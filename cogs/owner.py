...
class Owner:
    ...
    async def owner(self, ctx):
        ...
        if self.bot.settings.no_prompt is True:
            await self.bot.say("Console interaction is disabled. Start VBot "
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets VBot's prefixes for this server
    ...
    async def _blacklist_add(self, user: GlobalUser):
        """Adds user to VBot's global blacklist"""
    ...
    async def _blacklist_remove(self, user: GlobalUser):
        """Removes user from VBot's global blacklist"""
    ...
    async def _whitelist_add(self, user: GlobalUser):
        """Adds user to VBot's global whitelist"""
    ...
    async def _whitelist_remove(self, user: GlobalUser):
        """Removes user from VBot's global whitelist"""
    ...
    async def restart(self, silently : bool=False):
        """Attempts to restart VBot

        Makes VBot quit with exit code 26
    ...
    @commands.command()
    async def info(self):
        """Shows info about VBot"""
        author_repo = "https://www.roblox.com/users/73275369/profile"
        red_repo = author_repo + "/Red-DiscordBot"
        server_url = "https://discord.gg/pmwynbF"
        dpy_repo = "https://github.com/Rapptz/discord.py"
        python_url = "https://www.python.org/"
        since = datetime.datetime(2017, 9, 16, 0, 0)
        ...
        about = (
            "This is an instance of [VBot, an open source Discord bot]({}) "
            "created by [Dope#9579]({}) and improved by many.\n\n"
            "VBot is backed by a passionate community who contributes and "
        ...
        embed.add_field(name="About VBot", value=about, inline=False)
        embed.set_footer(text="Bringing joy since 16 Sep 2017 (over "
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of VBot hasn't been installed with git."
