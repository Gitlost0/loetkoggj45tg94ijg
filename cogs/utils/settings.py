...
class Settings:
    ...
    def parse_cmd_arguments(self):
        ...
        parser.add_argument("--admin-role", help="Role seen as admin role by "
                                                 "VBot")
        parser.add_argument("--mod-role", help="Role seen as mod role by VBot")
        ...
        parser.add_argument("--no-cogs",
                            action="store_true",
                            help="Starts VBot with no cogs loaded, only core")
        parser.add_argument("--self-bot",
                            action='store_true',
                            help="Specifies if VBot should log in as selfbot")
        ...
        parser.add_argument("--dry-run",
                            action="store_true",
                            help="Makes VBot quit with code 0 just before the "
